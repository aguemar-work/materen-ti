...
- `crear_notificacion(tipo, entidad_tipo, entidad_id, titulo, url)` (migración 045) — inserta en `notificaciones` y publica por realtime en `notificaciones:nuevas`; usado por los 4 triggers de notificación, nunca llamado directo desde el cliente.
