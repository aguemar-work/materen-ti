...
console.log('\n✓ Tests de triggers OK (008 exclusividad, 009 rotación, 017 reabrir, 019 transiciones, 031/032 kb_articulos, 033 problemas, 038 baja atómica, 051/061/053 RPCs sin sesión) — rollback aplicado');
process.exit(0);
