...
const GRIS_CABECERA = [238, 238, 238];
const GRIS_LINEA = [187, 187, 187];
const GRIS_TEXTO = [90, 90, 90];
const NEGRO = 20;
...
function celdaVacia(texto, columnas) {
...
function bloqueKpis(doc, items, y) {
  const hueco = 3;
...
function tabla(doc, autoTable, { head, body, columnStyles }, y) {
  autoTable(doc, {
    ...ESTILOS_TABLA,
    startY: y,
